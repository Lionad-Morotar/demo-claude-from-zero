...
[^1]: [Claude Code 官方文档总入口](https://docs.anthropic.com/en/docs/claude-code/overview)
[^2]: [Slash Commands 官方文档](https://docs.anthropic.com/en/docs/claude-code/slash-commands)
[^3]: [Hooks 官方文档](https://docs.anthropic.com/en/docs/claude-code/hooks)
[^4]: [Settings & 权限官方文档](https://docs.anthropic.com/en/docs/claude-code/settings)
[^5]: [CLI Reference 官方文档](https://docs.anthropic.com/en/docs/claude-code/cli-reference)
[^6]: [Skills 官方文档](https://docs.anthropic.com/en/docs/claude-code/skills)
[^7]: [MCP（Model Context Protocol）官方站](https://modelcontextprotocol.io/)
[^8]: [MCP 在 Claude Code 中的使用](https://docs.anthropic.com/en/docs/claude-code/mcp)
[^9]: [Memory（CLAUDE.md）官方文档](https://docs.anthropic.com/en/docs/claude-code/memory)
[^10]: [Subagents 官方文档](https://docs.anthropic.com/en/docs/claude-code/sub-agents)
[^11]: [Anthropic 官方博客：Best Practices for Claude Code](https://www.anthropic.com/engineering/claude-code-best-practices)
[^12]: [Prompt Caching 官方文档](https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching)