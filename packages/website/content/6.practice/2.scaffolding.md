...
[^1]: [Vite 官方文档](https://vite.dev/guide/) — 现代前端构建工具的事实标准
[^2]: [Turborepo 官方文档](https://turborepo.com/docs) — Monorepo 任务编排与远程缓存
[^3]: [TypeScript Handbook](https://www.typescriptlang.org/docs/handbook/intro.html) — TS 官方教程，配置 tsconfig 必读
[^4]: [Vue 3 官方指南](https://cn.vuejs.org/guide/introduction.html) — Composition API、SFC、生态总览（中文）
[^5]: [React 官方文档](https://react.dev/learn) — 含官方推荐脚手架与元框架建议
[^6]: [pnpm 文档](https://pnpm.io/zh/motivation) — 包管理与 workspace 设计哲学
[^7]: [Anthropic Claude Code 官方文档](https://code.claude.com/docs) — Claude Code 安装、Plan 模式、Skills、Hooks 全览
[^8]: [Model Context Protocol 规范](https://modelcontextprotocol.io/introduction) — MCP 协议本身与生态服务器列表
[^9]: [context7 项目主页](https://context7.com/) — 实时文档 MCP 服务，缓解 LLM 训练数据过时问题
[^10]: [The Twelve-Factor App](https://12factor.net/zh_cn/) — 现代应用架构经典原则，选型时的"对照基线"
[^11]: [Awesome Claude Code](https://github.com/hesreallyhim/awesome-claude-code) — 社区维护的 Claude Code 资源集
[^12]: [State of JS 2024](https://2024.stateofjs.com/) — 前端生态年度调查，选型参考数据来源之一