...
[^1]: [Anthropic Claude Code 官方文档](https://docs.anthropic.com/claude/docs/claude-code)
[^2]: [Boris Cherny: Claude Code 工程心法（YouTube 公开演讲）](https://www.youtube.com/results?search_query=boris+cherny+claude+code)
[^3]: [Vitest 官方文档](https://vitest.dev/)
[^4]: [Playwright 官方文档](https://playwright.dev/)
[^5]: [Mock Service Worker（MSW）官方文档](https://mswjs.io/)
[^6]: [Stryker Mutator 变异测试工具](https://stryker-mutator.io/)
[^7]: [Mike Cohn: The Forgotten Layer of the Test Pyramid](https://www.mountaingoatsoftware.com/blog/the-forgotten-layer-of-the-test-automation-pyramid)
[^8]: [Martin Fowler: Test Pyramid](https://martinfowler.com/articles/practical-test-pyramid.html)
[^9]: [Google Web Vitals 官方文档](https://web.dev/vitals/)
[^10]: [OpenTelemetry 官方文档](https://opentelemetry.io/docs/)
[^11]: [Conventional Commits 规范](https://www.conventionalcommits.org/zh-hans/)
[^12]: [ISTQB 软件测试基础大纲](https://www.istqb.org/certifications/certified-tester-foundation-level)
[^13]: [Kent Beck: Test-Driven Development By Example](https://www.oreilly.com/library/view/test-driven-development/0321146530/)
[^14]: [Martin Fowler: Refactoring（重构）官方资源站点](https://refactoring.com/)
[^15]: [Anthropic: Claude Code Best Practices Blog](https://www.anthropic.com/news)