...
[^1]: [How to Install Claude Code in 2026 - LaoZhang AI Blog](https://blog.laozhang.ai/en/posts/how-to-install-claude-code) — 覆盖六种安装方式的综合指南
[^2]: [Claude Code Installation Guide for Windows - DEV Community](https://dev.to/xujfcn/claude-code-installation-guide-for-windows-git-path-environment-variables-powershell-wsl-and-1lag) — Windows 安装深度指南，含 PATH 和环境变量详解
[^3]: [Installing Claude Code on Windows - PQ.Hosting](https://pq.hosting/en/help/install-claude-code-windows) — Windows 原生安装、WinGet 和 WSL 方案
[^4]: [How to Set Up Claude Code on Windows Using WSL - lowtouch.ai](https://www.lowtouch.ai/claude-code-windows-wsl-setup-guide/) — WSL 完整配置指南
[^5]: [中国大陆安装 Claude Code 完全指南 - hoopyAI](https://www.hoopyai.space/post/claude-code-china-install) — 不翻墙、零成本的国产模型接入方案
[^6]: [国内环境下 Claude Code 安装、更新与配置淘宝镜像 - CSDN](https://blog.csdn.net/binbingeee/article/details/158964151) — npm + 淘宝镜像的详细步骤
[^7]: [Claude Code 国内直连教程 - 火山引擎开发者社区](https://developer.volcengine.com/articles/7631799708167438355) — 含一键配置脚本
[^8]: [国内使用 Claude Code 教程 - 掘金](https://juejin.cn/post/7572142436127817747) — API 中转站配置指南
[^9]: [Claude Code Windows 安装与配置 - 博客园](https://www.cnblogs.com/Comets9224/p/19535975) — 国内模型避坑指南
[^10]: [anthropics/claude-code](https://github.com/anthropics/claude-code) — 官方仓库
[^11]: [claude-code-chinese/claude-code-guide](https://github.com/claude-code-chinese/claude-code-guide) — 中文社区指南