...
[^1]: [Set up single sign-on (SSO)](https://support.claude.com/en/articles/13132885-set-up-single-sign-on-sso) — SSO 配置步骤
[^2]: [Models, usage, and limits in Claude Code](https://support.claude.com/en/articles/14552983-models-usage-and-limits-in-claude-code) — 使用量计量和限制说明
[^3]: [How do I pay for my Claude API usage?](https://support.claude.com/en/articles/8977456-how-do-i-pay-for-my-claude-api-usage) — API 预付费机制
[^4]: [Use Claude Code with your Team or Enterprise plan](https://support.claude.com/en/articles/11845131-use-claude-code-with-your-team-or-enterprise-plan) — 企业计划使用指南
[^5]: [Claude Enterprise Administrator Guide](https://claude.com/resources/tutorials/claude-enterprise-administrator-guide) — 四阶段企业部署 playbook
[^6]: [Claude Pricing](https://claude.com/pricing) — 所有计划的官方定价和功能对比
[^7]: [How to Fix Claude Code "API Error: 401"](https://smartscope.blog/en/generative-ai/claude/claude-code-401-auth-error-fix/) — 401 错误的系统修复方法
[^8]: [Claude Code OAuth Token Expiry: Fixes & Alternatives](https://daveswift.com/claude-oauth-update/) — Token 过期机制和替代方案
[^9]: [Claude Switch](https://claudeswitch.dev/) — 多账户切换开源工具
[^10]: [Claude Code Multi-Account Setup](https://dev.to/ashishxcode/claude-code-multi-account-setup-without-losing-context-49nf) — 多账户配置实践