...
| 框架 | 语言/生态 | 典型命令 |
|------|----------|---------|
| Jest | JavaScript/Node.js | `npm test` / `npx jest` |
| Vitest | JavaScript/Node.js | `npx vitest` |
| pytest | Python | `pytest -v` |
| Go Test | Go | `go test ./...` |
| JUnit | Java | `mvn test` / `./gradlew test` |
| RSpec | Ruby | `bundle exec rspec` |
| Playwright | E2E (JS/TS) | `npx playwright test` |
| Cypress | E2E (JS/TS) | `npx cypress run` |
| REST Assured | API (Java) | `mvn test` |
