...
[^1]: [How to navigate any codebase with Claude Code](https://www.eesel.ai/blog/navigate-codebase-claude-code) — Eesel.ai 的深度实践指南
[^2]: [Best Practices for Large Codebases with Claude Code](https://www.thinkinpython.com/post/claude-code-large-codebase-best-practices.html) — 大型代码库的分层知识库实践
[^3]: [Code Architecture: A Practical Guide](https://deeprepo.dev/blog/code-architecture-guide) — DeepRepo 的架构识别方法论
[^4]: [Building a Graph-Based Code Analysis Engine](https://rustic-ai.github.io/codeprism/blog/graph-based-code-analysis-engine/) — CodePrism 的通用 AST 与图分析引擎
[^5]: [Using AI for Dependency Mapping in Large Codebases](https://devoxsoftware.com/blog/using-ai-for-dependency-mapping-in-large-codebases-a-practical-approach/) — AI 驱动的依赖映射实践
[^6]: [GitNexus: Codebase as Knowledge Graph](https://www.virge.io/en/blog/gitnexus-code-knowledge-graph/) — 将代码库转换为知识图谱的工具
[^7]: [Parallel Sub-Agents in Claude Code](https://proofsource.ai/2025/12/parallel-sub-agents-in-claude-code-multiplying-your-development-speed/) — 并行子代理的性能实测
[^8]: [How to Use Claude Code Sub-Agents for Parallel Work](https://timdietrich.me/blog/claude-code-parallel-subagents/) — 并行工作实践指南
[^9]: [Top 10 Code Analysis Tools For Enterprises](https://www.qodo.ai/blog/code-analysis-tools/) — 企业级代码分析工具对比
[^10]: [Code Quality Metrics: SonarQube and CodeClimate](https://johal.in/code-quality-metrics-sonarqube-and-codeclimate-for-technical-debt-reduction-strategies-2026/) — 技术债务量化与减少策略
[^11]: [SonarQube Metric Definitions](https://docs.sonarsource.com/sonarqube-server/user-guide/code-metrics/metrics-definition) — SonarQube 指标定义官方文档
[^12]: [Understanding Key Software Architecture Patterns](https://dev.to/sahilkalra/understanding-key-software-architecture-patterns-monolith-microservices-monorepo-and-more-3m91) — 软件架构模式概览
[^13]: [Automated Microservice Pattern Instance Detection](https://arxiv.org/abs/2502.04188) — 微服务模式自动检测学术论文